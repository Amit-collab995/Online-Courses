...
import Lecture from "../modules/lectureModel.js";
...
export const getPublishedCourses = async (req, res) => {
  try {
    ...
    return res
      .status(500)
      .json({ message: `failed to find ispublished Courses` });
  }
};
...
export const removeCourse = async (req, res) => {
    try {
        ...
        return res.status(500).json({message:`failed to | Course by id ${error}`})
    }
}

...
const ReviewCard = ({comment, rating, photoUrl, name, description, courseTitle }) => {
  return (
    <div className='bg-white p-6 rounded-xl shadow-md hover:shadow-lg transition-all duration-300 max-w-sm w-full'>
        ...
        <p className='text-gray-600 text-sm '>Review For : <span className='font-semibold'>{courseTitle}</span> </p>
        <p className='text-gray-600 text-sm mb-5'>Review : <span className='font-semibold'>{comment}</span></p>

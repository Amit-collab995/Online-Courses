...
const AllCourses = () => {
  ...
  return (
    <div className="flex min-h-screen bg-gray-50">
      ...
      {/* sideBar */}
      <aside className={`w-[260px] h-screen overflow-y-auto mt-17 bg-black fixed left-0 p-6 py-[13px] border-r border-gray-200 shadow-md transition-transform duration-300 z-5 ${
    isSideBarVisible ? "translate-x-0" : "-translate-x-full"
      ...
      >
        ...
        >
          <button className="px-[10px] rounded-2xl py-[10px bg-black text-white text-[15px] font-light flex items-center justify-center gap-2 cursor-pointer  ">
            Search with AI
            <img src={ai} className="w-[30px] h-[30px] " alt="" />{" "}
          </button>
      ...
      <main className="w-[84%] right-0 transition-all absolute  duration-300 py-[13px] mt-17  flex items-start justify-center md:pl-[130px] flex-wrap gap-6 px-[20px] ">
